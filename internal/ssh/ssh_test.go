...
func TestBuildSSHCommand_AdditionalCases(t *testing.T) {
	...
	known := &parser.SSHHost{Name: "host.local", HostName: "host.local", Port: "22", Source: "known_hosts"}
	...
	known2 := &parser.SSHHost{Name: "srv", HostName: "srv.example", User: "admin", Port: "2200", Source: "known_hosts"}
